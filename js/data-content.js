...
const SCENES = {
  village: {
    ...
    npcs:[
      { id:'villager1', name:'마을 이장', icon:'👴', x:7, y:6,
        dialogue:[
          '오, {name} 왔구나. 자네가 그... 요즘 불이야 소리치고 다닌다는 애 맞지?',
          '허허, 나쁘게 보려는 건 아니니 서운해하지 말게. 다들 그냥 하는 말이지.',
          '마침 잘 됐네, {name}. 요즘 마을 곳곳에 화재 위험이 도사리고 있어 걱정이었거든.',
          '{name} 자네가 우리 집부터 한번 살펴봐 주지 않겠나? 뭐라도 보여주면 사람들 생각도 조금은 달라질지 몰라.'
        ] },
      { id:'stationWorker', name:'지하철 역무원', icon:'👮', x:9, y:7,
        dialogue:[
          '어? {name}, 자네가 그 소문의 아이로군... 마을 이장님이 이야기하시던.',
          '요즘 지하철역이랑 지하상가 쪽에서 좀 이상한 열기가 느껴져서 걱정이야.',
          '{name}, 가서 한번 살펴봐 줄 수 있겠나?'
        ] },
    ],
    shopAt:[{x:5,y:4}],
  },
  hq: {
    ...
    spawn:{x:4,y:3},
    doors:[ { x:4, y:0, to:'village', spawn:{x:3,y:8}, label:'마을' } ],
    npcs:[],
    hqUpgradeAt:[{x:4,y:1}],
  },
  home_dungeon: {
    ...
    spawn:{x:5,y:1},
    doors:[ { x:6, y:0, to:'village', spawn:{x:10,y:8}, label:'마을' } ],
    npcs:[],
    fireEvents:[
  ...
  subway_dungeon: {
    ...
    spawn:{x:5,y:1},
    doors:[ { x:6, y:0, to:'village', spawn:{x:7,y:8}, label:'마을' } ],
    npcs:[],
    fireEvents:[
