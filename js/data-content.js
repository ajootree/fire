  ...
  village: {
    ...
    npcs:[
      { id:'villager1', name:'마을 이장', icon:'👴', x:7, y:6,
        dialogue:[
          '오, 왔구나. 자네가 그... 요즘 불이야 소리치고 다닌다는 애 맞지?',
          '허허, 나쁘게 보려는 건 아니니 서운해하지 말게. 다들 그냥 하는 말이지.',
          '마침 잘 됐네. 요즘 마을 곳곳에 화재 위험이 도사리고 있어 걱정이었거든.',
          '자네가 우리 집부터 한번 살펴봐 주지 않겠나? 뭐라도 보여주면 사람들 생각도 조금은 달라질지 몰라.'
        ] },
      { id:'stationWorker', name:'지하철 역무원', icon:'👮', x:9, y:7,
        dialogue:[
          '어? 자네가 그 소문의 아이로군... 마을 이장님이 이야기하시던.',
